    ...
    listTech: [
      {
        ...
        alt: "Javascript",
        descFr: "Site réalisé en Javascript, HTML et CSS.",
        descEn: "Site made in Javascript, HTML and CSS.",
      },
      {
        name: "Sass",
      ...
      {
        name: "Nginx",
        logo: "./assets/images/logos/Nginx_64.svg",
        alt: "Nginx",
        descFr: "Serveur web open source (reverse proxy).",
        descEn: "Open source web server (reverse proxy).",
      },
      {
        name: "Debian 11",
        logo: "./assets/images/logos/Debian_64.svg",
        alt: "Debian 11",
        descFr: "Hébergement chez Hostinger sous Debian 11.",
        descEn: "Hosting at Hostinger under Debian 11.",
      },
      {
        name: "GitHub",
  ...
  },
  {
    ...
    listTech: [
      ...
      },
      {
        ...
        logo: "./assets/images/logos/Debian_64.svg",
        alt: "Debian 11",
        descFr: "Hébergement sur serveur Nginx sous Debian 11.",
        descEn: "Hosting on Nginx server under Debian 11.",
      },
      {
        name: "Socket.io",
  ...
  },
  {
    ...
    listTech: [
      ...
      },
      {
        ...
        logo: "./assets/images/logos/GitHubW_64.svg",
        alt: "GitHub",
        descFr: "Versioning en équipe avec Git via GitHub.com",
        descEn: "Team versioning with Git via GitHub.com.",
      },
      {
        name: "Swagger",
